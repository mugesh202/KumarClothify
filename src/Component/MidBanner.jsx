...
export default function MidBanner() {
  return (
   <div className='bg-gray-100 py-24'>
       ...
       <h1 className='text-3xl md:text-5xl lg:text-6xl font-bold mb-4'>Winter Collection in 2024</h1>
       <p className='text-lg md:text-xl mb-6'>Discover the hottest trends for the season. Limited time offer: 20% off new arrivals!</p>
